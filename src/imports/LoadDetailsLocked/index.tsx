import svgPaths from "./svg-x3sn901z16";
...
function Button() {
  return (
    <div className="absolute content-stretch flex gap-[6px] h-[19.5px] items-center left-[320px] top-[86px]" data-name="Button">
      <Icon2 />
      <p className="[word-break:break-word] font-['Helvetica_Neue:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#0d7a6e] text-[14px] text-center whitespace-nowrap">Back to Loads</p>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="h-[36px] relative shrink-0 w-[105.367px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Helvetica_Neue:Medium',sans-serif] leading-[30px] left-0 not-italic text-[#1f2937] text-[24px] top-0 whitespace-nowrap">Load / Shipment Detail</p>
      </div>
    </div>
  );
}
...
function PageHeader() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[320px] top-[129.5px] w-[1088px]" data-name="PageHeader">
      <Container8 />
      <Paragraph />
    </div>
  );
...
function Text6() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Helvetica_Neue:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#1a1a1a] text-[14px] whitespace-nowrap">10401</p>
      </div>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="h-[27.5px] relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Helvetica_Neue:Regular',sans-serif] leading-[21px] left-0 not-italic text-[#1a1a1a] text-[14px] top-[-0.5px] whitespace-nowrap">Scheduled</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[195px] relative shrink-0 w-full" data-name="Table">
      <div className="[word-break:break-word] bg-clip-padding border-0 border-[transparent] border-solid leading-[21px] not-italic relative size-full text-[14px] whitespace-nowrap">
        ...
        <TableRow2 />
        <TableRow3 />
        <p className="absolute font-['Helvetica_Neue:Regular',sans-serif] left-[770px] text-[#1f2937] top-[54px]">Confirmed</p>
        <p className="absolute font-['Helvetica_Neue:Regular',sans-serif] left-[770px] text-[#1f2937] top-[159px]">Confirmed</p>
        <p className="absolute font-['Helvetica_Neue:Regular',sans-serif] left-[770px] text-[#1f2937] top-[106px]">Confirmed</p>
      </div>
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p2566d000} id="Vector" stroke="var(--stroke-0, #9CA3AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1bf79e00} id="Vector_2" stroke="var(--stroke-0, #9CA3AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Paragraph2() {
  return (
    <div className="relative shrink-0" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Helvetica_Neue:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#6b7280] text-[0px] w-[986px]">
          <span className="leading-[21px] text-[14px]">{`Date change requests are not available once a shipping ticket has been confirmed. To make changes, contact `}</span>
          <span className="leading-[21px] text-[#374151] text-[14px]">Pittsburgh Rebar Co.</span>
          <span className="leading-[21px] text-[14px]">{` directly.`}</span>
        </p>
      </div>
    </div>
  );
...
function Container22() {
  return (
    <div className="bg-[#f9fafb] relative rounded-[6px] shrink-0 w-full" data-name="Container">
      <div aria-hidden className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="content-stretch flex gap-[12px] items-start p-[21px] relative size-full">
        <IconMargin />
        <Paragraph2 />
      </div>
    </div>
...
function Container21() {
  return (
    <div className="bg-white drop-shadow-[0px_1px_1.5px_rgba(0,0,0,0.1),0px_1px_1px_rgba(0,0,0,0.1)] h-[154px] relative rounded-[8px] shrink-0 w-full" data-name="Container">
      <div aria-hidden className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="content-stretch flex flex-col items-start p-[25px] relative size-full">
        <Heading3 />
        <ContainerMargin2 />
...
function Text16() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#9ca3af] text-[12px] whitespace-nowrap">Screen variant:</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <a className="bg-white cursor-pointer relative rounded-[16777200px] shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[13px] py-[5px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#1a1a1a] text-[12px] text-center whitespace-nowrap">Open — Date Change Available</p>
      </div>
    </a>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#0d7a6e] relative rounded-[16777200px] shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[13px] py-[5px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">Locked — Ticket Confirmed</p>
      </div>
    </div>
  );
}
...
function ContainerMargin3() {
  return (
    <div className="content-stretch flex flex-col items-center pb-[16px] relative shrink-0 w-full" data-name="Container:margin">
      <Container23 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[27px] items-start left-[320px] top-[196px] w-[1088px]">
      <ContainerMargin />
      <Container18 />
      <Container21 />
      <ContainerMargin3 />
...
export default function LoadDetailsLocked() {
  return (
    <div className="bg-white relative size-full" data-name="Load Details - Locked">
